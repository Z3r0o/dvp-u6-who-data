...
Chile, China, German, Mexico, United States of America, Zimbabwe
...
sns.barplot(data=df, x='Country', y='GDP', palette='deep')
plt.xticks(rotation=90)
plt.savefig("bar gdp.png")
plt.show()
...
sns.barplot(data=df, x='Country', y='LEABY', palette='deep')
plt.xticks(rotation=90)
plt.savefig("bar leaby.png")
plt.show()
...
Not really. Some of the general relationships are similar, such as Mexico's GDP and LEABY both being lower than Germany's and the US's. But China's GDP is higher than four of the countries listed and their LEABY is lower than four. 
...
sns.violinplot(data=df, x='Country', y='LEABY', palette='dark')
...
plt.xticks(rotation=90)
plt.ylabel('GDP in Trillions of U.S. Dollars')
ax.set(ylabel='Life expectancy at virth in years')
plt.savefig("bartime leaby.png")
plt.show()
...
While both GDP and Life Expectancy rise over time, their relationship doesn't seem to be a direct one. Zimbabwe's GDP as changed the least over time while their Life Expectancy has changed the most. Western countries like the United States and Germany have steady rises in Life Expectancy but Germany has a fluctuating GDP over time. China and the United States, the largest economies, have similarly large rises in GDP and also the steadiest rise in life expectancy.  
...
China moves the most along the x axis (GDP) and Zimbabwe moves the most along the Y axis (Life Expectancy at Birth).
This is surprising in that I would expect life expectancy and GDP to move together, and that China's life expectancy would increase more. Though, given its already high life expectancy in the year 2000 and Zimbabwe's low life expectancy in the same year, I shouldn't be that surprised at the amount of Zimbabwe's increase. 
I also do like the scatter plots, I was always a fan of flip books. 
...
plt.savefig("line facet leaby.png")
plt.show()
...
plt.savefig("line facet gdp.png")
plt.show()
...
The United States has the highest while Zimbabwe has the lowest.
...
China invested over 500 billion in infrastructure and economic lending power to weather the global economic crisis. 
